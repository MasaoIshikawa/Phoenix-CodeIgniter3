 ...
 function get_request_token()
{
 ...
 $request = OAuthRequest::from_consumer_and_token($this->consumer,
     $this->token, 'GET',"https://twitter.com/oauth/request_token", $args);
...
// $token = $this->parse_access($request);
 ...
 $this->token = new OAuthConsumer($_GET['oauth_token'],
     $_GET['oauth_verifier']);
$token['oauth_token']= $_GET['oauth_token'];
$token['oauth_token_secret']= $_GET['oauth_verifier'];
 return $token;
 }
