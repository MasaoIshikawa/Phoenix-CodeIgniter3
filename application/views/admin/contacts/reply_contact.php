  ...
  <?php $this->load->view('admin/left-menu'); ?>
    ...
    <div id="right-contents"> 
      ...
      <div class="row">
        <div class="col-sm-7">
          <form class="reply-form" action="<?php echo base_url('admin/contacts/send/'.$contact['contact_id']); ?>" method="post">
            <p class="clearfix">
              <label>Name:</label>
              <span>
            ...
            <p>
              <input type="text" placeholder="Subject" class="form-control validate[required]" id="subject" name="subject" >
            </p>
            <p>
            ...
            <div class="text-right view-submit">
              ...
              <button class="link-btn grey" type="reset" onClick="window.location='<?php echo base_url('admin/contacts'); ?>'" name="">Back</button>
            </div>
          </form>
          <!-- end reply form --> 
        </div>
